...
func (t *Transaction) GenerateSignature() *utils.Signature{
	...
	r,s, _ := ecdsa.Sign(rand.Reader, t.senderPrivateKey, h[:]) //since ecdsa.Sign takes variable of type []byte as the last argument and the hash is of [32]byte, we add [:] to remove the limitation of [32]byte and treat the variable as regular []byte 
